...
Мы научились работать с средством автоматизации ansible, который позволяет в декларативной 
манере описывать требуемое состояние системы и caddy - простой системе проксирования, 
позволяющей очень просто настроить https подключение. 
